...
namespace WindowsGame1
{
    class InputController
    {
        ...
        public bool IsCreateSpawnPointNewlyReleased()
        {
            switch (m_Mode)
            {
                case InputMode.Player1:
        ...
        public bool IsCancelSurfaceNewlyPressed()
        {
            switch (m_Mode)
            {
                case InputMode.Player1:
        ...
        public bool IsSetReflectiveNewlyPressed()
        {
            switch (m_Mode)
            {
                case InputMode.Player1:
        ...
        public bool IsSetRefractiveNewlyPressed()
        {
            switch (m_Mode)
            {
                case InputMode.Player1:
        ...
        public bool IsSetAbsorbantNewlyPressed()
        {
            switch (m_Mode)
            {
                case InputMode.Player1:
